...
namespace MagicCrow.Abilities
{
	...
	public class Animate : Ability
	{
		...
		public AttributGroup<Target> Types;
		...
		{			
			...
			case "Permanent":
				...
				return true;
//			case "Types":
//				Types = CardTarget.ParseTargets (value);
//				return true;
//			case "OverwriteTypes":
//				OverwriteTypes = CardTarget.ParseTargets (value);
//				return true;
//			case "RemoveTypes":
//				RemoveTypes = CardTarget.ParseTargets (value);
//				return true;
			case "ChosenType":
				Permanent = bool.Parse (value);
				return true;
